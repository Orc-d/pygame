...
class Upgrade:
    ...
    def create_items(self):
        ...
        for item, index in enumerate(range(self.attribute_nr)):
            ...
            #전체 가로에서 구성요소 수를 나눠 개별 요소의 크기를 구함
...
class Item:
    ...
    def display_names(self,surface,name,cost,selected):
        #한줄 if 기본적으로 else 뒤의 것을 가지고 if 성립하면 앞에게 값이 됨
    ...
    def display_bar(self,surface,value,max_value,selected):
        ...
        # 15 는 폭(30)의 절반, relative_numver 는 max_value 를 최대 값으로 가지는 value 값에 전체 크기를 곱한 범위
